# OpenStudio × Dutch Public Sector (UWV) — Regulatory Compliance Mapping · v1
...
> PROJECT_SPEC.md v4) to the regulatory stack applicable to UWV as a Dutch ZBO deploying
> data/AI systems. It is an engineering compliance-by-design mapping, **not legal advice**;
> UWV's FG (DPO), CISO, privacy office and legal counsel must validate every conclusion.
> Items marked ⏳ were in legislative motion in mid-2026 and must be re-verified before
> production use.

---

## 1. UWV's regulatory stack (what applies and why)

| Instrument | Type | Why it applies to UWV + this platform |
|---|---|---|
...
| **Wet SUWI + Besluit/Regeling SUWI** | NL law | UWV's institutional law: task delineation, data exchange (Suwinet/GeVS), purpose binding, security & accountability requirements |
...
| **CRA (Cyber Resilience Act)** ⏳ phased 2026-2027 | EU regulation | Relevant to OpenStudio as distributed software (open-source steward regime); light for UWV as deployer |
...
- *Provider* (Art 16 ff.) — likely, wherever UWV develops agents/models in-house for its own
...
- **Prohibited (design out, Art 5)**: social scoring; untargeted scraping; emotion recognition
  ...
  SyRI judgment and UWV's own *Risicoscan Verblijf Buiten Nederland* affair (covert web
...
under the light "open-source steward" regime; if UWV (or anyone) commercializes distribution,
...
Journal do they confer presumption of conformity (Art 40). Practical consequence for UWV:
...
**Why it fits UWV.** BIO2 already presumes an ISO 27001-style ISMS; 42001 is designed to
...
**Gate for UWV production**: a consolidated "Compliance hardening" milestone — all CP items
...
If UWV pursues ISO/IEC 42001 certification, the AI-governance board doubles as AIMS owner,
...
| **2 Dec 2027** | Annex III high-risk obligations apply (UWV benefit-eligibility AI) |
| 2 Aug 2028 | Annex I embedded high-risk obligations apply |

## 8. Open items to re-verify (feed for deep research)
OJ publication date + final consolidated text of the Digital Omnibus; whether UWV falls
...
harmonised standards, plus NEN adoption of EN ISO/IEC 42001; UWV-specific frameworks (UWV
